...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":";AACA;IACI,SAAS;IACT,UAAU;IACV,gBAAgB;IAChB,sBAAsB;IACtB,gBAAgB;IAChB,yCAAyC;;AAE7C;;AAEA;IACI,aAAa;IACb,aAAa;IACb,sDAAsD;IACtD,oBAAoB;IACpB,qBAAqB;IACrB,mBAAmB;;AAEvB;;AAEA;IACI,aAAa;IACb,YAAY;IACZ,0BAA0B;AAC9B;;AAEA;IACI,4BAA4B;AAChC;AACA;IACI,aAAa;IACb,cAAc;IACd,yBAAyB;IACzB,eAAe;IACf,yBAAyB;IACzB,UAAU;AACd;;AAEA;IACI,kBAAkB;IAClB,YAAY;AAChB;AACA;IACI,0BAA0B;AAC9B;;;AAGA;IACI,iBAAiB;IACjB,UAAU;IACV,mBAAmB;IACnB,YAAY;IACZ,kBAAkB;IAClB,uBAAuB;AAC3B;;;;AAIA;IACI,cAAc;IACd,UAAU;IACV,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,mBAAmB;IACnB,SAAS;AACb;;AAEA;IACI,aAAa;IACb,SAAS;IACT,cAAc;IACd,uBAAuB;IACvB,sBAAsB;IACtB,eAAe;AACnB;;AAEA;IACI,sBAAsB;IACtB,uBAAuB;AAC3B;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,iBAAiB;IACjB,mBAAmB;IACnB,kBAAkB;IAClB,YAAY;AAChB;;AAEA;IACI,iBAAiB;AACrB;AACA;IACI,kBAAkB;IAClB,yBAAyB;AAC7B;;AAEA;IACI,aAAa;IACb,eAAe;IACf,OAAO;AACX;;;AAGA;IACI,aAAa;IACb,QAAQ;AACZ;AACA;IACI,kBAAkB;IAClB,mBAAmB;IACnB,gBAAgB;IAChB,gCAAgC;IAChC,YAAY;IACZ,SAAS;IACT,kBAAkB;;AAEtB","sourcesContent":["\n*{\n    margin: 0;\n    padding: 0;\n    list-style: none;\n    box-sizing: border-box;\n    background: none;\n    font-family: Arial, Helvetica, sans-serif;\n\n}\n\n.content{\n    height: 100vh;\n    display: grid;\n    grid-template-columns: [start]1fr [start-end]0fr [end];\n    grid-auto-rows: auto;\n    justify-items: center;\n    align-items: center;\n\n}\n\n.content-table{\n    padding: 10px;\n    margin: 10px;\n    grid-column: start-end/end;\n}\n\n.content-form{\n    grid-column: start/start-end;\n}\ntable{\n    padding: 10px;\n    margin: 0 auto;\n    border: 1px solid #ff0000;\n    font-size: 1rem;\n    border-collapse: collapse;\n    width: 80%;\n}\n\nth{\n    font-size: 1.45rem;\n    padding: 5px;\n}\nth::first-letter{\n    text-transform: capitalize;\n}\n\n\ntd{\n    font-size: 1.2rem;\n    width: 15%;\n    height: fit-content;\n    padding: 5px;\n    text-align: center;\n    border: 2px solid #cccc;\n}\n\n\n\nform {\n    margin: 0 auto;\n    width: 80%;\n    display: flex;\n    flex-direction: column;\n    text-align: center;\n    align-items: center;\n    gap: 15px;\n}\n\n.form-div, .date-div{\n    display: flex;\n    gap: 15px;\n    margin: 0 auto;\n    justify-content: center;\n    align-self:flex-start ;\n    flex-wrap: wrap;\n}\n\n.form-div{\n    flex-direction: column;\n    align-items: flex-start;\n}\n\n.form-div input, .form-div select{\n    width: 90%;\n}\n\n.form-div input, .form-div select, .date-div input{\n    font-size: 1.65em;\n    border-radius: 10px;\n    text-align: center;\n    padding: 8px;\n}\n\nlegend, .weather-options-div div label{\n    font-size: 1.75em;\n}\n.form-div select{\n    width: fit-content;\n    background-color: #efefef;\n}\n\n.weather-options-div{\n    display: flex;\n    flex-wrap: wrap;\n    gap:8px;\n}\n\n\n.weather-options-div div{\n    display: flex;\n    gap: 5px;\n}\n.submit-button{\n    padding: 10px 22px;\n    border-radius: 10px;\n    font-size: 1.5em;\n    background-color: cornflowerblue;\n    color: white;\n    border: 0;\n    width: fit-content;\n    \n}"],"sourceRoot":""}]);
// Exports
